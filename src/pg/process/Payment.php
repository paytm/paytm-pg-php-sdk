    ...
    class Payment
    {
            ...
            if ($paymentDetails instanceof PaymentDetail) {
                try {
                    ...
                    return Request::process($request, $url,
                        'InitiateTransactionResponse', $paymentDetails->getReadTimeout(), MerchantProperties::getConnectionTimeout());
        ...
        private static function setSignature($head, $body)
        {
            if ($head instanceof SecureRequestHeader) {
                ...
                $signature = EncDecUtil::getChecksumFromString($formattedJsonBody, MerchantProperties::getMerchantKey());
            ...
            if ($paymentStatusDetail instanceof PaymentStatusDetail) {
                ...
                try {
                    ...
                    return Request::process($request, MerchantProperties::getPaymentStatusUrl(),
                        "NativePaymentStatusResponse", $paymentStatusDetail->getReadTimeout(), MerchantProperties::getConnectionTimeout());
